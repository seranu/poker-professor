...
TEST_CASE("Hand value test")
{
    ...
    SECTION("High card") {
        auto cards = GENERATE(
                    HighCardExpectation { *Cards::fromString("6h 3h 8d 5h 9s Jc Kd")
                        , HighCard{ CardRanks( { CardRank::King, CardRank::Jack, CardRank::Nine, CardRank::Eight, CardRank::Six} ) } },
                    HighCardExpectation { *Cards::fromString("2d Kd 9d Qh 3d 7c 4c")
                        , HighCard{ CardRanks( {CardRank::King, CardRank::Queen, CardRank::Nine, CardRank::Seven, CardRank::Four } ) } },
                    HighCardExpectation { *Cards::fromString("Kd 6s 2c Js Ah 7c 8s")
                        , HighCard{ CardRanks( {CardRank::Ace, CardRank::King, CardRank::Jack, CardRank::Eight, CardRank::Seven } ) } }
        );
